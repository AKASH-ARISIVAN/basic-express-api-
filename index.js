...
app.get('/',(req,res)=>{
    res.send('books management API ,, /retrieve - list all books ,'+
        '/retrieve/id - get particular book ,/add - add new book ,'+
        '/update/id - update a book for given id , /delete/id - delete a book ');
})
